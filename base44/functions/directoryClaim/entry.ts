        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;background:#ffffff;border-radius:20px;overflow:hidden;border:1px solid #dfe9e2;">
          ...
          <tr>
            <td style="padding:6px 32px 8px;">
              ...
              <p style="font-size:15px;line-height:1.6;color:#55636f;margin:0 0 16px;">There’s also a <strong>Feedback</strong> area in RallyHub for anything you spot, suggestions or wishlist ideas. The Events page is under construction too, so if you have thoughts on what would actually be useful there, I’d really like to hear them.</p>
              <p style="font-size:15px;line-height:1.6;margin:0 0 8px;">Don’t be afraid to tell me what doesn’t make sense — that’s exactly what this beta testing is for. Thanks for helping me get this right.</p>
