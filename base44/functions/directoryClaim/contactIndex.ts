// Generated from the current RallyHub directory data. Server-side only.
// Regenerate when trusted directory contact data changes.

export const directoryVerificationIndex = [
  {
