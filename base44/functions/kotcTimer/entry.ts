...
Deno.serve(async(req)=>{try{
 ...
 if(!state||String(state.roundId)!==roundId){state={roundId,roundNumber:Number(round.round_number||0),durationSeconds:duration,remainingSeconds:duration,running:false,deadlineAt:null,lastAction:'reset'};}
