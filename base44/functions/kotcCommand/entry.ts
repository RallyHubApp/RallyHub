...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (commandType === 'autosave_score') {
      ...
      const destinationRank:any={}; for(const s of sportingSlots)destinationRank[s.participant_id]=s.ladder_court_rank; const benchPlaces=eligible.length-activeCourts*4;
