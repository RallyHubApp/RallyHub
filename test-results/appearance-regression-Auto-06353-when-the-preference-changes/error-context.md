...
- Name: appearance-regression.spec.mjs >> Auto follows the device preference and updates when the preference changes
- Location: e2e/appearance-regression.spec.mjs:38:1
...
Call log:
  - waiting for getByRole('button', { name: 'Auto appearance' })
