...
Locator: getByText('Session complete')
Expected: visible
Timeout: 3000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByText('Session complete') with timeout 3000ms
  - waiting for getByText('Session complete')

```

```yaml
- heading "Tournament Control Centre" [level=1]
- paragraph: 1 event · create, run and review competitions
...
- button "Club Challenge Two-club event with fairness, live scoring and event-day controls.":
  - img
  - img
  - paragraph: Club Challenge
  - paragraph: Two-club event with fairness, live scoring and event-day controls.
- img
- textbox "Search tournaments..."
- combobox: All Statuses
- link "King of the Court 830 Session Completed 16 players Review & edit results":
  - /url: /app/tournaments/6aa2df782975f38410d2a90a
  - text: King of the Court
  - heading "830 Session" [level=3]
  - text: Completed
  - img
  - text: 16 players Review & edit results
  - img
```
