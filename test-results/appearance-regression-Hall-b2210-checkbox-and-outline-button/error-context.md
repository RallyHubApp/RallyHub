...
- Name: appearance-regression.spec.mjs >> Hall mode visibly strengthens core controls including slider, number input, checkbox and outline button
- Location: e2e/appearance-regression.spec.mjs:48:1
