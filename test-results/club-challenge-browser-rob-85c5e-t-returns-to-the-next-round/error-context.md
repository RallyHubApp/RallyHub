...
Locator: getByText('RECOVERY NEEDED')
Expected: visible
Timeout: 3000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByText('RECOVERY NEEDED') with timeout 3000ms
  - waiting for getByText('RECOVERY NEEDED')
...
- main:
  ...
  - button "Start 20-min Break · 4 scores pending"
  - paragraph: Live Event
  - paragraph: Round 6 of 12
  - paragraph: Clare Blue 0 – 0 Clare Gold
  - text: 0W 0D 0W
  - img
  - paragraph: Break next · 20 minutes
  - paragraph: Scheduled immediately after Round 6. Round 7 will wait until the host ends the break.
