...
Expected substring: "Loading preview…"
Timeout: 3000ms
...
> 40 |   await expect(page.getByTestId('kotc-email-players')).toContainText('Loading preview…');
  ...
  58 |   expect(functionCalls.filter(x=>x==='kotcResultsShare')).toHaveLength(2);
