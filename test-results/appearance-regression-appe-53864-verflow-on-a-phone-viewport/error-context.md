...
- Name: appearance-regression.spec.mjs >> appearance controls and core fields remain usable without horizontal overflow on a phone viewport
- Location: e2e/appearance-regression.spec.mjs:98:1
...
Call log:
  - waiting for getByRole('button', { name: 'Hall appearance' })
...
- main [ref=e3]:
  - generic [ref=e4]:
    ...
    - generic [ref=e8]:
      - button "Auto" [ref=e9] [cursor=pointer]
      - button "Light" [ref=e21] [cursor=pointer]
      - button "Hall" [ref=e28] [cursor=pointer]
      - button "Dark" [pressed] [ref=e32] [cursor=pointer]
    - generic [ref=e35]:
      - generic [ref=e36]:
        - generic [ref=e37]:
          - text: Score / number control
          - spinbutton "Score / number control" [ref=e38]: "11"
        - generic [ref=e39]:
          - text: Dropdown
          - combobox "Test dropdown" [ref=e40] [cursor=pointer]:
            - generic: Court one
      - generic [ref=e43]:
        - checkbox "Test checkbox" [checked] [ref=e44] [cursor=pointer]
        - generic [ref=e45]: Visible checkbox
      - generic [ref=e46]:
        - text: Hall volume slider
        - generic "Test slider" [ref=e47]:
          - slider [ref=e51]
      - generic [ref=e52]:
        - button "Primary action" [ref=e53] [cursor=pointer]
        - button "Secondary action" [ref=e54] [cursor=pointer]
        - button "Destructive action" [ref=e55] [cursor=pointer]
```
