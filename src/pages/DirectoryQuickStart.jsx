...
export default function DirectoryQuickStart() {
  return (
    <div className="min-h-screen bg-[#f7faf9] text-[#07184c]">
      <Seo title="RallyHub Directory Quick Start Guide" description="The approved two-page quick start guide for clubs claiming and managing a RallyHub Directory listing." path="/directory/quick-start" robots="index,follow" />
      ...
      <main className="mx-auto max-w-[1120px] px-4 py-8 sm:px-6 lg:px-10">
        ...
        <section className="overflow-hidden rounded-[24px] border border-[#dbe6e8] bg-white shadow-[0_14px_40px_rgba(8,24,77,.08)]">
          <div className="flex items-center justify-between gap-4 border-b border-[#dbe6e8] px-4 py-3 sm:px-5">
            <p className="text-sm font-bold">Approved RallyHub Directory Quick Start Guide</p>
          ...
          <object data={PDF_URL} type="application/pdf" className="block h-[82vh] min-h-[720px] w-full bg-white" aria-label="RallyHub Directory Quick Start Guide">
