    ...
    <div className="mx-auto max-w-2xl space-y-5">
      ...
      <form onSubmit={submit} className="space-y-5">
        ...
        <section className="glass rounded-2xl p-5 sm:p-6 space-y-4">
          ...
          <label className="flex items-start gap-3 rounded-xl border p-4 text-sm"><input type="checkbox" className="mt-0.5 h-4 w-4" checked={form.waiverAccepted} onChange={e=>set('waiverAccepted',e.target.checked)} required/><span><strong>I have read and accept the guest session declaration and liability waiver.</strong></span></label>
