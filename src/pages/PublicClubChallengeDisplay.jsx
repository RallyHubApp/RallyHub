...
export default function PublicClubChallengeDisplay(){
  ...
  if(view==='vote') return <div className="min-h-screen bg-background text-foreground p-4 sm:p-8"><AppearanceQuickButton className="fixed right-3 top-3 z-40 h-10 px-2 sm:px-3"/>{playerNav}<div className="mx-auto max-w-xl"><LiveEventBrand pageLabel="Players of the Tournament Voting"/><div className="mt-5 rounded-2xl border bg-card p-5 sm:p-7 shadow-sm">
    <Trophy className="mx-auto h-10 w-10 text-primary"/><h1 className="mt-2 text-center text-2xl font-black">Players of the Tournament</h1><p className="mt-2 text-center text-sm text-muted-foreground">Choose one player from each team when voting is open.</p>
