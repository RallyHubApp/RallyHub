...
export default function PublicClubChallengeDisplay(){
  ...
  if(showcaseActive) return <div className="min-h-screen bg-background text-foreground p-4 sm:p-6 flex flex-col">
    ...
    {potOpen&&<div className="mb-3 rounded-2xl border-2 border-primary/40 bg-primary/10 px-4 py-3 text-center"><p className="text-xs sm:text-sm font-black uppercase tracking-[.18em] text-primary">Players of the Tournament voting open</p><p className="mt-1 text-2xl sm:text-4xl font-black tabular-nums">{potCountdown}</p></div>}
  ...
  return <div className="min-h-screen bg-background text-foreground p-4 sm:p-8 space-y-6">
    ...
    {potOpen&&<div className="rounded-2xl border-2 border-primary/40 bg-primary/10 p-4 text-center"><p className="text-sm sm:text-lg font-black uppercase tracking-[.16em] text-primary">Players of the Tournament voting open</p><p className="mt-1 text-3xl sm:text-5xl font-black tabular-nums">{potCountdown}</p><p className="mt-1 text-xs sm:text-sm text-muted-foreground">Scan the event voting QR and choose one player from each team.</p></div>}
