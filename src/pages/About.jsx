...
export default function About(){
 ...
 <div className="min-h-screen bg-white font-sans text-[#07184c]"><Header/><main>
  ...
  <section className="mx-auto grid max-w-[1024px] gap-[28px] px-[30px] pb-[19px] md:grid-cols-[47%_53%]">
   <div className="relative h-[296px] overflow-hidden rounded-[5px] bg-[#e9eef0]"><img src={FOUNDERS+'2041005ec_logo_fixed.png'} alt="Conall and Brian Moore" className="hidden"/><img src="/assets/rallyhub-founders.webp?v=20260921b" alt="Conall and Brian Moore" className="absolute inset-0 h-full w-full object-cover object-[50%_38%]"/><div className="absolute bottom-0 left-[10px] rounded-t-[5px] bg-[#075287] px-[12px] py-[8px] text-white"><div className="text-[11px] font-bold">Conall and Brian Moore</div><div className="text-[9px]">Founders, RallyHub</div></div></div>
  ...
  <section className="bg-white px-[30px] pb-[24px]"><div className="mx-auto grid min-h-[225px] max-w-[964px] overflow-hidden rounded-[6px] bg-[#073d65] text-white md:grid-cols-[32%_43%_25%]"><div className="overflow-hidden"><img src={CTA_COMMUNITY} alt="Pickleball community" className="h-full min-h-[225px] w-full object-cover"/></div><div className="flex items-center px-[28px] py-[25px]"><div><div className="text-[9px] font-black tracking-[.12em] text-[#65d77d]">JOIN THE JOURNEY</div><h2 className="mt-[7px] text-[25px] font-black">Let’s grow the game together</h2><p className="mt-[6px] text-[11px] leading-[1.45] text-white/95">Whether you’re a player, club, organiser or just curious about pickleball, we’d love to hear from you.</p><div className="mt-[15px] flex flex-wrap gap-[12px]"><Link to="/contact" className="rounded-[5px] bg-[#08a65a] px-[31px] py-[11px] text-[10px] font-bold">Get in Touch</Link><a href="https://wa.me/353878100333" target="_blank" rel="noreferrer" className="flex items-center gap-2 rounded-[5px] border border-white px-[18px] py-[10px] text-[10px] font-bold"><MessageCircle className="h-5 w-5"/>Contact Brian on WhatsApp</a></div></div></div><div className="relative hidden overflow-hidden md:block"><img src={CTA_SCENIC} alt="Irish landscape" className="absolute inset-0 h-full w-full object-cover"/><div className="absolute inset-0 bg-[#073d65]/35"/><div className="absolute left-1/2 top-1/2 flex h-[154px] w-[154px] -translate-x-1/2 -translate-y-1/2 rotate-[-5deg] items-center justify-center rounded-full border-[3px] border-white text-center text-[17px] font-semibold italic leading-[1.3]">More People<br/>More Places<br/><span className="text-[#b7e83e]">Brighter Futures</span></div></div></div></section>
 </main></div></>;
}