...
export default function PublicKotcResults(){
  ...
  if(error&&!data)return <div className="min-h-screen bg-background text-foreground grid place-items-center p-4"><AppearanceQuickButton className="fixed right-3 top-3 z-50 h-10 px-2 sm:px-3"/><div className="glass rounded-xl p-5 max-w-md w-full text-center"><RallyHubModuleBrand moduleName="King of the Court" pageLabel="Live Event View"/><h1 className="font-bold mt-5">Live KOTC unavailable</h1><p className="text-sm text-muted-foreground mt-2">{error}</p></div></div>;
  if(!data)return <div className="min-h-screen bg-background text-foreground grid place-items-center"><AppearanceQuickButton className="fixed right-3 top-3 z-50 h-10 px-2 sm:px-3"/><div className="text-center"><RallyHubModuleBrand moduleName="King of the Court" pageLabel="Live Event View"/><RefreshCw className="animate-spin mx-auto mt-5"/></div></div>;
    ...
    return <div className="min-h-screen bg-background text-foreground p-4 sm:p-6" data-testid="public-kotc-hall-display">
      ...
      <main className="max-w-[1600px] mx-auto space-y-4">
        <header className="grid grid-cols-[1fr_auto] items-start gap-4">
          <div className="min-w-0"><RallyHubModuleBrand moduleName="King of the Court" pageLabel="Live Event View" align="left"/><h1 className="text-2xl sm:text-4xl font-bold mt-2 truncate">{data.session.name}</h1></div>
          <div className="flex flex-col sm:flex-row gap-2 items-end"><AppearanceQuickButton/><Button variant="outline" size="sm" onClick={()=>toggleHall(false)} data-testid="exit-hall-display"><Minimize2 className="w-4 h-4 mr-1"/>Exit Display</Button></div>
        </header>
  ...
  return <div className="min-h-screen bg-background p-3 sm:p-5"><main className="max-w-5xl mx-auto space-y-4">
    ...
    <header className="glass rounded-xl p-5 text-center relative">
      ...
      <div className="flex justify-center"><RallyHubModuleBrand moduleName="King of the Court" pageLabel="Live Event View"/></div>
