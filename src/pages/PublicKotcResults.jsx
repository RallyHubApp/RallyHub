...
import { Crown,Trophy,RefreshCw,WifiOff,MonitorUp,Minimize2 } from 'lucide-react';
...
export default function PublicKotcResults(){
  ...
  const [hallMode,setHallMode]=useState(()=>new URLSearchParams(window.location.search).get('display')==='1');
  ...
  return <div className="min-h-screen bg-background p-3 sm:p-5"><main className="max-w-5xl mx-auto space-y-4">
    ...
    <header className="glass rounded-xl p-5 text-center relative">
      ...
      <p className="text-[10px] uppercase tracking-[.22em] text-primary font-bold mt-3 sm:mt-0">King of the Court · Live</p>
