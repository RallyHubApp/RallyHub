...
export default function PublicEventLanding({ tournament, players, callPublicRegister, onRefresh, liveIndicator, clubBrand=null }) {
      ...
      <div className="max-w-2xl mx-auto space-y-5">
        <div className="glass rounded-3xl p-6 sm:p-8 border border-primary/10 glow-green">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
            <RallyHubPublicBrand moduleName={tournament.format || 'Tournament'} pageLabel="Event" club={clubBrand} align="left"/>
