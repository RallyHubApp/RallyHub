        ...
        <div className="space-y-4">
          ...
          <div className="glass rounded-xl p-4 sm:p-5 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:flex lg:flex-wrap gap-3 lg:gap-4 text-xs">
              ...
              <label className="flex items-center gap-3 min-h-10 rounded-lg bg-secondary/40 px-3"><input className="w-4 h-4" type="checkbox" checked={setup.potEnabled} onChange={e => setSetup(s => ({ ...s, potEnabled: e.target.checked }))} /> Team player awards · choose Highest Scorer or Vote at the end</label>
            ...
            <div ref={hostBarAnchorRef} style={hostBarPinned ? { height: hostBarGeometry.height } : undefined}>
              ...
              <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                ...
                <div className="ml-auto flex flex-wrap items-center gap-2">
                  ...
                  {!['completed','archived'].includes(event.status) && !breakActive && !timerRunning && ['ready','idle'].includes(timerPhase) && <Button size="sm" className="bg-emerald-600 text-white hover:bg-emerald-700" disabled={!canManageEvent} onClick={()=>startPhase('play')}><Play className="w-4 h-4 mr-1" />Start Round {currentRound}</Button>}
