...
export default function InterclubPrintPack({ event, tournament, matches=[], participants=[], score, overallScore, showcaseMatch, sections }) {
  ...
  return <div className="rhpp-root">
    <style>{`
      ...
      .rhpp-score-grid{display:grid;grid-template-columns:10mm repeat(4,minmax(0,1fr));grid-template-rows:6.5mm repeat(12,13.95mm);width:100%;height:173.9mm;box-sizing:border-box;border-left:.25mm solid #88abc4;border-top:.25mm solid #88abc4;overflow:hidden}.rhpp-score-grid-head{background:${BLUE};color:#fff;border-right:.25mm solid #d7e7f2;border-bottom:.25mm solid #d7e7f2;display:flex;align-items:center;justify-content:center;font-size:6.2pt;font-weight:800}.rhpp-score-grid-round-head{font-size:5.8pt}.rhpp-round-number{border-right:.25mm solid #88abc4;border-bottom:.25mm solid #88abc4;display:flex;align-items:center;justify-content:center;text-align:center;font-size:10.5pt;font-weight:900;background:#eef8fd;min-width:0;min-height:0;overflow:hidden}.rhpp-score-cell{border-right:.25mm solid #88abc4;border-bottom:.25mm solid #88abc4;text-align:center;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:.3mm .45mm;box-sizing:border-box;min-width:0;min-height:0;overflow:hidden}.rhpp-score-name{font-size:4.45pt;line-height:1.02;height:3.5mm;max-width:100%;overflow:hidden;display:flex;align-items:center;justify-content:center;text-align:center;white-space:nowrap;text-overflow:ellipsis}.rhpp-score-boxes{height:4.7mm;display:flex;justify-content:center;align-items:center;gap:1.1mm;flex:none}.rhpp-score-boxes span{width:6mm;height:4.8mm;border:.35mm solid #52728d;border-radius:.7mm;display:inline-block}.rhpp-score-boxes b{font-size:5.2pt}.rhpp-empty{color:#8399ab;font-style:italic}.rhpp-score-bottom{display:grid;grid-template-columns:1.25fr .95fr;gap:2.2mm;margin-top:2.2mm;height:25mm}.rhpp-notes-box,.rhpp-reminders{height:25mm;background:#f1f8fc;border-radius:2mm;padding:2mm;box-sizing:border-box;font-size:5.7pt}.rhpp-notes-box strong,.rhpp-reminders strong{font-size:6.3pt}.rhpp-notes-box i{display:block;border-bottom:.25mm solid #567998;height:4.4mm}.rhpp-reminders ul{margin:1.4mm 0 0;padding-left:4mm;line-height:1.5}
