...
export default function InterclubPrintPack({ event, tournament, matches=[], participants=[], score, overallScore, showcaseMatch, sections, displayUrl='', votingUrl='' }) {
  ...
  return <div className="rhpp-root">
    <style>{`
      ...
      .rhpp-page{page:portraitPack;position:relative;width:210mm;height:297mm;box-sizing:border-box;padding:6mm 7mm 22mm;background:#fff;color:${NAVY};overflow:hidden;border:.25mm solid #d7e6f2}.rhpp-score-page{page:scoreLandscape;width:296mm;height:209mm;padding:4.5mm 7mm 20mm;margin:0;box-sizing:border-box}
